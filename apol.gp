...
\\ACP=Apollonian circle packaing
	\\MAIN METHODS
		...
		install("apol_ncgp_forms","GD1,L,D1,L,p","apol_ncgp_forms","./libapol.so");
		...
		install("apol_ncgp_smallcurve","GD1,L,p","apol_ncgp_smallcurve","./libapol.so");
