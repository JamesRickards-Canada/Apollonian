...
/*quadratic.c*/
  ...
  if (lex(parigp_version[1..3], [2, 16, 2]) >= 0, install(qfb_ZM_apply,"GG",qfbapply), install(qfb_apply_ZM,"GG",qfbapply));/*In PARI but not installed. Name changed during 2.16.2.*/
